  ...
  return (
    <div style={{ padding: '1.5rem' }}>
      <style>{`
        ...
        .her-tab:hover { color: #0D9488 !important; }
        .menu-item:hover { background: #F0FDFA !important; }
        ...
        {TABS.map(t => (
          ...
          >
            ...
            <span style={{
              ...
              background: tab === t.id ? '#CCFBF1' : '#F3F4F6',
              color:      tab === t.id ? '#0D9488' : '#9CA3AF',
            }}>
              {t.count}
            </span>
          </button>
      ...
      {cargando ? (
        ...
        <div style={{ textAlign: 'center', padding: '2.5rem 0' }}>
          ...
          {!busqueda && tab === 'todas' && (
            <button onClick={abrirCrear} style={{ ...sBtnInline, color: '#0D9488', fontWeight: '700', marginTop: '0.5rem' }}>
      ...
      {pendRestaurar && (
        <ModalConfirmar
          ...
          etiquetaConfirmar="Sí, restaurar" colorConfirmar="#0D9488"
...
function AreaCard({ area, onVer, onEditar, onToggleActivo, onArchivar, onRestaurar, onEliminar }: {
  ...
  const borde  = area.archivado ? '#D97706' : area.activo ? '#0D9488' : '#9CA3AF'
    ...
    <div ref={ref} style={{ position: 'relative', flexShrink: 0 }}>
      <button
        ...
        style={{
          ...
          background: abierto ? '#F0FDFA' : 'transparent',
          border: abierto ? '1px solid #99F6E4' : '1px solid transparent',
        ...
        <form onSubmit={handleSubmit} style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            <button type="button" onClick={() => setForm(f => ({ ...f, activo: !f.activo }))}
              style={{ width: '44px', height: '24px', borderRadius: '999px', border: 'none', cursor: 'pointer', position: 'relative', flexShrink: 0, background: form.activo ? '#0D9488' : '#D1D5DB', transition: 'background 0.2s' }}>
...
const sBtnPrimario: CSSProperties   = { background: 'linear-gradient(135deg, #0D9488, #0F766E)', color: 'white', border: 'none', borderRadius: '8px', padding: '0.5rem 1.125rem', fontSize: '0.875rem', fontWeight: '600', cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: '0.375rem' }
...
const sBtnInline: CSSProperties     = { background: 'none', border: 'none', cursor: 'pointer', fontSize: '0.875rem', padding: 0, color: '#0D9488', fontWeight: '600' }
